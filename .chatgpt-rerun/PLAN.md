...
- [ ] Side Panel remains usable while interacting with the ChatGPT page and restores unsaved draft values after reopen.
- [ ] Start bootstraps the runner on an already-open ChatGPT tab without requiring a page refresh.
...
|---|---|---|---|---|
| E2E-001 | pending | - | Verify Side Panel persistence, initial automatic dispatch, and transition to a new sequence | Side Panel persists/autosaves, Start works on an already-open ChatGPT tab, resume prompt is sent for seq 0, and seq 1/E2E-002 starts without manual input |
